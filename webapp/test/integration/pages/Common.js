sap.ui.define([
	...
	return Opa5.extend("Manage.com.management.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Manage/com/management/localService/mockserver"], function (mockserver) {
